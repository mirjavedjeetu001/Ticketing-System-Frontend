        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6 p-4 bg-gray-100 rounded-md">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <div>
                <strong>Super Admin:</strong> javed@iamsheba.xyz / SuperAdmin2024!
              </div>
              <div>
                <strong>Admin:</strong> admin@shebapulse.com / admin123
              </div>
              <div>
                <strong>Agent:</strong> agent@shebapulse.com / agent123
              </div>
            </div>
          </div>
        </form>
