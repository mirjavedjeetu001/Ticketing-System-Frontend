...
import { Search, Settings, Shield, AlertTriangle } from 'lucide-react';

const AdminSeverityPage: React.FC = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
                Severity Levels Management
              </h1>
              <p className="text-slate-600 font-medium mt-2">Set up severity levels and priorities</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl shadow-slate-900/10 overflow-hidden">
          <div className="p-8">
            <DynamicSeverityManagement searchTerm={searchTerm} />
          </div>
        </div>
      </div>
    </div>
...
export default AdminSeverityPage;